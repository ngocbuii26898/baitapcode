    ...
    <div class="wmuSlider example1" style="height: 560px;" >
        <div class="wmuSliderWrapper">
            ...
            <article style="position: absolute; width: 100%; opacity: 0;">
                <div class="banner-wrap">
                    <div class="slider-left">
                        <img src="{{URL::asset('image/banner3.jpg')}}" alt="" />
                    </div>
                    <div class="slider-right">
                        <h1>Classic</h1>
                        <h2>White</h2>
            ...
            <article style="position: absolute; width: 100%; opacity: 0;">
                <div class="banner-wrap">
                    <div class="slider-left">
                        <img src="{{URL::asset('image/banner4.jpg')}}" alt="" />
                    </div>
                    <div class="slider-right">
                        <h1>Classic</h1>
                        <h2>White</h2>
            ...
            <article style="position: absolute; width: 100%; opacity: 0;" >
                <div class="banner-wrap">
                    <div class="slider-left">
                        <img src="{{URL::asset('image/banner5.jpg')}}" alt="" />
                    </div>
                    <div class="slider-right">
                        <h1>Classic</h1>
                        <h2>White</h2>
...
<div class="main" ng-controller="productsController">
    <div class="wrap">
        ...
        <div class="content-bottom">
            <div class="box1">
                <div class="col_1_of_3 span_1_of_3" ng-repeat="pro in Products" style="margin-left:0px; margin-right:43px; height:353px;">
                    <a href="http://localhost/shoe_store/public/single/<%pro.id%>">
                                ...
                                <ul class="icon1 sub-icon1 profile_img">
                                    <li>
                                        @if(Session::get("username") != "")
                                            <a style="margin-button:1px; height: 31.5px" class="active-icon c1" href="single/buyProductnow/<%pro.idProducts%>">BUY NOW</a>
                                        @else
