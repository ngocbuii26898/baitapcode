        ...
        <div class="content-bottom">
            <div class="box1">
                ...
                <div class="col_1_of_3 span_1_of_3" ng-repeat="pro in Products" style="margin-left:0px; margin-right:43px">
                    <a href="http://localhost/shoe_store/public/single/<% pro.idProducts %>/<%pro.name%>/<%pro.price%>/<%pro.image%>/<%pro.category%>/<%pro.describe%>/<%pro.content_details%>/<%pro.reviews%>/<%pro.created_at%>">
                        ...
                        <div class="rating" style="background: #4747f7; width:50%">
                            <a href="updateProducts/<%pro.idProducts%>" style="margin-left: 45px; color:white">UPDATE</a>
                        </div>
